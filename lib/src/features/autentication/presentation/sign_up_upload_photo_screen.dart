...
import 'package:sarang_app/src/common_widgets/costum_text_button_widget.dart';
...
import 'package:sarang_app/src/features/autentication/presentation/bloc/auth_bloc.dart';
    ...
    return Scaffold(
      ...
      child: Padding(
        padding: const EdgeInsets.symmetric(
            vertical: AppPadding.p50, horizontal: AppMargin.m24),
                            ...
                            child: Row(
                              ...
                              children: [
                                IconButton(
                                    ...
                                    icon:
                                        Icon(Icons.camera, size: AppSize.s50)),
                                IconButton(
                                    onPressed: () {
                                      getImageProfile(GetImageFrom.gallery);
                                    },
                                    icon: Icon(Icons.photo, size: AppSize.s50)),
                              ],
                            ),
                          );
                        });
              ...
              BlocBuilder<AuthBloc, AuthState>(
                builder: (context, state) {
                  ...
                  return CustomButtonWidget(
                      ...
                      SnackBar(content: Text('No Update Image')));
                      return;
                        }
